...
export const metadata: Metadata = {
  title: 'سياسة الخصوصية | مؤسسة الديار العالمية - حماية بياناتك أولويتنا',
  description: 'سياسة الخصوصية لمؤسسة الديار العالمية. نحن ملتزمون بحماية خصوصيتك وبياناتك الشخصية وفقاً لأعلى المعايير الأمنية.',
  openGraph: {
    title: 'سياسة الخصوصية | مؤسسة الديار العالمية',
    description: 'سياسة الخصوصية لمؤسسة الديار العالمية. نحن ملتزمون بحماية خصوصيتك وبياناتك الشخصية.',
    type: 'website',
    locale: 'ar_SA'
  }
}
        ...
        <section className="py-20 px-4 bg-gradient-to-br from-primary/5 to-accent/5">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              نحن في مؤسسة الديار العالمية ملتزمون بحماية خصوصيتك وضمان أمان بياناتك الشخصية
            </p>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 md:p-12 space-y-8">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  تحدد سياسة الخصوصية هذه كيفية قيام مؤسسة الديار العالمية ("نحن"، "لنا"، "الشركة") بجمع واستخدام وحماية
              ...
              <div className="bg-primary/5 rounded-lg p-6">
                ...
                <div className="space-y-2 text-gray-700">
                  <p><strong>البريد الإلكتروني:</strong> privacy@aldeyar-jeddah.com</p>
