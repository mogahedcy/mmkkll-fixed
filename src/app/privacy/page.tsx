...
export const metadata: Metadata = {
  title: 'سياسة الخصوصية | محترفين الديار العالمية - حماية بياناتك أولويتنا',
  description: 'سياسة الخصوصية لمحترفين الديار العالمية. نحن ملتزمون بحماية خصوصيتك وبياناتك الشخصية وفقاً لأعلى المعايير الأمنية.',
  openGraph: {
