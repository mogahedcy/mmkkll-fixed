      ...
      <aside className="col-span-12 md:col-span-3 lg:col-span-2 border-l bg-white/95 backdrop-blur-sm shadow-lg">
        <div className="p-6 space-y-6 h-full flex flex-col">
          ...
          <nav className="space-y-1 flex-1">
            ...
            <Link href="/dashboard/seo-health" className="group flex items-center gap-3 rounded-xl px-4 py-3 text-gray-700 hover:bg-gradient-to-r hover:from-emerald-50 hover:to-teal-50 hover:text-emerald-700 transition-all duration-200">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
              </svg>
              <span className="font-medium">صحة SEO</span>
