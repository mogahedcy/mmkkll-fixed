...
export const metadata: Metadata = {
  ...
  keywords: 'شروط الخدمة، الأحكام والشروط، سياسات الخدمة، محترفين الديار العالمية',
        ...
        <section className="py-20 px-4 bg-gradient-to-br from-primary/5 to-accent/5">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              الشروط والأحكام التي تحكم استخدام خدمات محترفين الديار العالمية
            </p>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 md:p-12 space-y-8">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  مرحباً بكم في موقع محترفين الديار العالمية. هذه الشروط والأحكام ("الشروط") تحكم استخدامكم لموقعنا الإلكتروني
                  وخدماتنا المقدمة من قبل محترفين الديار العالمية ("نحن"، "لنا"، "الشركة").
