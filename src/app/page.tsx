...
export const metadata: Metadata = {
  title: 'محترفين الديار العالمية | مظلات وبرجولات جدة',
  description: 'محترفين الديار العالمية - شركة رائدة في تصميم وتركيب المظلات والبرجولات والسواتر في جدة. خبرة +15 سنة، ضمان 10 سنوات، وأسعار منافسة. اتصل الآن: 0553719009',
