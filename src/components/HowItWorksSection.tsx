  ...
  return (
    <section className="py-16 md:py-24 relative overflow-hidden bg-gradient-to-br from-gray-900 via-black to-gray-900">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute w-96 h-96 -bottom-48 -left-48 bg-blue-500/20 rounded-full blur-3xl animate-pulse" />
        <div className="absolute w-96 h-96 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-green-500/10 rounded-full blur-3xl animate-pulse" />
      </div>
