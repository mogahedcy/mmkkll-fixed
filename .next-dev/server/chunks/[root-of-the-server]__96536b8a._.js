...
function getClientIP(request) {
    return request.headers.get('x-forwarded-for') || request.headers.get('x-real-ip') || '0.0.0.0';
}
...
async function POST(request) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].admins.update({
            where: {
                id: admin.id
            },
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__96536b8a._.js.map